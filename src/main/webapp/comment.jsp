...
<head>
  ...
  <link rel="stylesheet" href="View/styles/styleComment.css">
...
<body>
  <div class="image">
    <a href="jspindex.html" class="home"><img src="Image/BHD-nền%20trong%20suốt.svg" alt=""></a>
  </div>
  <div class="wrapper">
    ...
    <div class="contain">
      ...
      <div class="list-policy">
        ...
        <div class="media">
          ...
          <a href="https://www.instagram.com/peace_bi.ht/" target="_blank"><img src="Image/instagram.png" alt="instagram-icon"></a>
        </div>
      </div>
      <div class="support">
        <div class="hotline">
